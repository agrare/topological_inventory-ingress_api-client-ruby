...
# Unit tests for TopologicalInventory::IngressApi::Client::ContainerTemplate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContainerTemplate' do
  before do
    # run before each test
    @instance = TopologicalInventory::IngressApi::Client::ContainerTemplate.new
  end
  ...
  describe 'test an instance of ContainerTemplate' do
    it 'should create an instance of ContainerTemplate' do
      expect(@instance).to be_instance_of(TopologicalInventory::IngressApi::Client::ContainerTemplate)
    end
  end
