...
# Unit tests for TopologicalInventory::IngressApi::Client::Vm
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Vm' do
  before do
    # run before each test
    @instance = TopologicalInventory::IngressApi::Client::Vm.new
  end
  ...
  describe 'test an instance of Vm' do
    it 'should create an instance of Vm' do
      expect(@instance).to be_instance_of(TopologicalInventory::IngressApi::Client::Vm)
    end
  end
