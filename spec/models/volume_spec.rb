...
# Unit tests for TopologicalInventory::IngressApi::Client::Volume
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Volume' do
  before do
    # run before each test
    @instance = TopologicalInventory::IngressApi::Client::Volume.new
  end
  ...
  describe 'test an instance of Volume' do
    it 'should create an instance of Volume' do
      expect(@instance).to be_instance_of(TopologicalInventory::IngressApi::Client::Volume)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["creating", "available", "in-use", "deleting", "deleted", "error", "unknown"])
